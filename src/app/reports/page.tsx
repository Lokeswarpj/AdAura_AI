      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight flex items-center gap-2">
            <FileText className="h-6 w-6 text-primary" /> Reports & Exports
          </h2>
          <p className="text-muted-foreground">
            Download your automated performance digests and build custom optimization briefs.
          </p>
        </div>
        <button onClick={() => setIsModalOpen(true)} className="btn-pill-gradient text-xs px-4 h-9 gap-1.5 shrink-0 cursor-pointer font-bold">
